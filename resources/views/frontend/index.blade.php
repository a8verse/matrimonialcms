        ...
        <path d="M254.67-237.33l-17.34-17.34L462.67-480,237.33-705.33l17.34-17.34L480-497.33,705.33-722.67l17.34,17.34L497.33-480,722.67-254.67l-17.34,17.34L480-462.67Z"
              transform="translate(-237.33 722.67)" fill="#A9A9A9" />
                                        ...
                                        <form class="form-default" id="reg-form" role="form"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            data-max-date="{{ get_max_date() }}" autocomplete="off"
                                                            required>
                                                        @error('date_of_birth')
                                                            <span class="invalid-feedback"
                                                                role="alert">{{ $message }}</span>
                                            ...
                                            <div class="">
                                                <button type="submit"
                                                    class="btn btn-block btn-primary round-btn">{{ translate('Create Account') }}</button>
                                            </div>
...
<script>
    ...
    showBtn.addEventListener('click', function () {
        formContainer.style.display = 'block'; // Make it visible
        void formContainer.offsetWidth; // Force reflow
        formContainer.classList.add('active'); // Slide in
    ...
    function closeSidebar() {
        formContainer.classList.remove('active'); // Slide out
        setTimeout(() => {
